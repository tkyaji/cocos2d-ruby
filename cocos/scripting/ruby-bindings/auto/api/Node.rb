...
--------------------------------
-- Unschedules a lambda function<br>
-- param key      The key of the lambda function to be unscheduled<br>
-- lua NA
...
--------------------------------
-- Schedules a lambda function that runs only once, with a delay of 0 or larger<br>
-- param callback      The lambda function to be scheduled<br>
-- param delay         The amount of time that the first tick will wait before execution.<br>
-- param key           The key of the lambda function. To be used if you want to unschedule it<br>
-- lua NA
...
--------------------------------
-- Schedules the "update" method with a custom priority.<br>
-- This selector will be called every frame.<br>
-- Scheduled methods with a lower priority will be called before the ones that have a higher value.<br>
...
--------------------------------
-- Unschedule all scheduled selectors and lambda functions: custom selectors, and the 'update' selector and lambda functions<br>
-- Actions are not affected by this method.<br>
-- lua NA
...
-- The default anchorPoint is (0.5,0.5), so it starts in the center of the node.<br>
-- note If node has a physics body, the anchor must be in the middle, you cann't change this to other value.<br>
...
-- All nodes has a size. Layer and Scene has the same size of the screen.<br>
...
-- Only one "update" method could be scheduled per node.<br>
-- js NA<br>
-- lua NA
