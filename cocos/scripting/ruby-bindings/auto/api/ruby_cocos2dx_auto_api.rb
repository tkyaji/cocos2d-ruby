...
--------------------------------------------------------
-- the CC Vec2
-- @field [parent=#CC] Vec2#Vec2 Vec2 preloaded module


--------------------------------------------------------
-- the CC Vec3
-- @field [parent=#CC] Vec3#Vec3 Vec3 preloaded module


--------------------------------------------------------
-- the CC Vec4
-- @field [parent=#CC] Vec4#Vec4 Vec4 preloaded module


--------------------------------------------------------
-- the CC Size
-- @field [parent=#CC] Size#Size Size preloaded module
...
--------------------------------------------------------
-- the CC Color4B
-- @field [parent=#CC] Color4B#Color4B Color4B preloaded module


--------------------------------------------------------
-- the CC Color4F
-- @field [parent=#CC] Color4F#Color4F Color4F preloaded module


--------------------------------------------------------
-- the CC AnimationFrameData
-- @field [parent=#CC] AnimationFrameData#AnimationFrameData AnimationFrameData preloaded module
...
--------------------------------------------------------
-- the CC PointArray
-- @field [parent=#CC] PointArray#PointArray PointArray preloaded module
...
--------------------------------------------------------
-- the CC NodeData
-- @field [parent=#CC] NodeData#NodeData NodeData preloaded module


--------------------------------------------------------
-- the CC NodeDatas
-- @field [parent=#CC] NodeDatas#NodeDatas NodeDatas preloaded module


--------------------------------------------------------
-- the CC Animation3DData
-- @field [parent=#CC] Animation3DData#Animation3DData Animation3DData preloaded module


--------------------------------------------------------
-- the CC Sprite3DData
-- @field [parent=#CC] Sprite3DData#Sprite3DData Sprite3DData preloaded module
