...
# This script is used to generate rubybinding glue codes.
...
def main():
    ...
    try:
        ...
        ruby_root = '%s/tools/ruby' % project_root
        output_dir = '%s/cocos/scripting/ruby-bindings/auto' % project_root

        cmd_args = {'cocos2dx.ini' : ('cocos2d-x', 'ruby_cocos2dx_auto'), \
#                    'cocos2dx_extension.ini' : ('cocos2dx_extension', 'ruby_cocos2dx_extension_auto'), \
                    'cocos2dx_ui.ini' : ('cocos2dx_ui', 'ruby_cocos2dx_ui_auto'), \
#                    'cocos2dx_studio.ini' : ('cocos2dx_studio', 'ruby_cocos2dx_studio_auto'), \
                    'cocos2dx_spine.ini' : ('cocos2dx_spine', 'ruby_cocos2dx_spine_auto'), \
#                    'cocos2dx_physics.ini' : ('cocos2dx_physics', 'ruby_cocos2dx_physics_auto'), \
                    'cocos2dx_experimental_video.ini' : ('cocos2dx_experimental_video', 'ruby_cocos2dx_experimental_video_auto'), \
                    'cocos2dx_experimental.ini' : ('cocos2dx_experimental', 'ruby_cocos2dx_experimental_auto'), \
#                    'cocos2dx_controller.ini' : ('cocos2dx_controller', 'ruby_cocos2dx_controller_auto'), \
#                    'cocos2dx_cocosbuilder.ini': ('cocos2dx_cocosbuilder', 'ruby_cocos2dx_cocosbuilder_auto'), \
#                    'cocos2dx_cocosdenshion.ini': ('cocos2dx_cocosdenshion', 'ruby_cocos2dx_cocosdenshion_auto'), \
                    'cocos2dx_3d.ini': ('cocos2dx_3d', 'ruby_cocos2dx_3d_auto'), \
                    'cocos2dx_audioengine.ini': ('cocos2dx_audioengine', 'ruby_cocos2dx_audioengine_auto'), \
#                    'cocos2dx_csloader.ini' : ('cocos2dx_csloader', 'ruby_cocos2dx_csloader_auto'), \
                    }
        ...
        print '---------------------------------'
        print 'Generating ruby bindings succeeds.'
        print '---------------------------------'

    except Exception as e:
        if e.__class__.__name__ == 'CmdError':
            print '---------------------------------'
            print 'Generating ruby bindings fails.'
            print '---------------------------------'
            sys.exit(1)
        else:
            raise
